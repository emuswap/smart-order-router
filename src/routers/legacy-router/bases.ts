...
export const BASES_TO_CHECK_TRADES_AGAINST = (
  ...
  return {
    ...
    [ChainId.CLASSIC]: [WRAPPED_NATIVE_CURRENCY[ChainId.CLASSIC]],
    [ChainId.CLASSIC_MORDOR]: [WRAPPED_NATIVE_CURRENCY[ChainId.CLASSIC_MORDOR]],
    ...
    [ChainId.ZIRCUIT]: [WRAPPED_NATIVE_CURRENCY[ChainId.ZIRCUIT]!],
    [ChainId.ZIRCUIT_SEPOLIA]: [WRAPPED_NATIVE_CURRENCY[ChainId.ZIRCUIT_SEPOLIA]!],
  };
};
